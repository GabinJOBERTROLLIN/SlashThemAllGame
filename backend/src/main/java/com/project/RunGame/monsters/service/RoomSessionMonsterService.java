...
import com.project.RunGame.monsters.model.MapOfMonster;
import com.project.RunGame.monsters.model.Monster;
import com.project.RunGame.monsters.model.MonsterDamageResult;
...
public class RoomSessionMonsterService {
	...
	private final Map<String,MapOfMonster> roomMonsters = new HashMap<String,MapOfMonster>();
